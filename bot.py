...
def ensure_sublist3r_installed():
    try:
        import sublist3r
    except ImportError:
        subprocess.check_call(['pip', 'install', 'git+https://github.com/aboul3la/Sublist3r.git'])

# Command handlers
def start(update: Update, context: CallbackContext):
    logger.info(f"User {update.message.from_user.id} initiated the bot.")
    keyboard = [
        [InlineKeyboardButton("Join Group", url="https://t.me/fakaoanl"), InlineKeyboardButton("Join Channel 1", url="https://t.me/found_us")],
        [InlineKeyboardButton("Join Channel 2", url="https://t.me/hacking_Mathod"), InlineKeyboardButton("Falconsec", url="https://youtube.com/@falconsec?si=ftkeWpCJ9b-u5Z2U")],
    ...
    update.message.reply_photo(
        photo='https://te.legra.ph/file/97b2b57cd7a33007de2ed.jpg',
        caption=(
...
def stats(update: Update, context: CallbackContext):
    ...
    total_scans = sum(user_limits.values())
